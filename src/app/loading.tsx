export default function Loading() {
  return (
    <div className="flex flex-col min-h-screen">
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-transparent">
      ...
      <main className="flex-1 flex flex-col items-center">
        <div className="w-full max-w-7xl px-3 sm:px-6 lg:px-8 py-3 sm:py-5 space-y-4 sm:space-y-6">
      ...
      <footer className="mt-auto border-t border-hairline/50">
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex items-center justify-center gap-1.5">
          <div className="h-1 w-1 rounded-full skeleton" />
