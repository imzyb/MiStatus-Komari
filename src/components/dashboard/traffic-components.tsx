  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-0.5 sm:gap-0 w-full">
      <div className="flex items-center">
        ...
        <span className="text-xs sm:text-sm font-semibold text-foreground font-mono">{formatBytes(download)}</span>
      </div>
      ...
      <div className="flex items-center">
        ...
        <span className="text-xs sm:text-sm font-semibold text-foreground font-mono">{formatBytes(upload)}</span>
      </div>
    </div>
  );
};